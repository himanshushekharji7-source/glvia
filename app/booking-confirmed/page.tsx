...
export default function BookingConfirmedPage() {
  const [booking, setBooking] = useState<any>({
    salonName: "Aura Prestige",
    salonAddress: "124 Elite Avenue, Beverly Hills",
    bookingId: "#LXS-2024-8742",
    date: "Today",
    timeSlot: "10:00 AM",
    services: "Signature Blowout, Gel Manicure",
    totalAmount: 119
  });
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="text-[15px] font-bold text-text-primary truncate">{booking.salonName}</h3>
            <p className="text-[12px] text-text-secondary truncate">{booking.salonAddress}</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[14px] font-bold text-text-primary">{booking.bookingId}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[14px] font-bold text-text-primary">{booking.date}, {booking.timeSlot}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[14px] font-semibold text-text-primary truncate">{booking.services}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[14px] font-bold text-text-primary">₹{booking.totalAmount}</div>
            </div>
          </div>
        </div>
      </div>
