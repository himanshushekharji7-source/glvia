  ...
  if (data.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
        <span className="material-icons-round text-gray-300 text-[48px] mb-3 block">inbox</span>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/50">
              ...
              {(onEdit || onDelete) && (
                <th className="text-right text-[11px] font-bold text-gray-500 uppercase tracking-wider px-4 py-3 w-24">
                  Actions
                </th>
              )}
            </tr>
                    ...
                    <div className="flex items-center justify-end gap-1">
                      {onEdit && (
                        <button
                          ...
                          title="Edit"
                        >
                          <span className="material-icons-round text-[16px] text-gray-400 group-hover:text-blue-500">
                            edit
                          </span>
                        </button>
                      )}
                      {onDelete && (
                        <button
                          ...
                          title="Delete"
                        >
                          <span className="material-icons-round text-[16px] text-gray-400 group-hover:text-red-500">
                            delete
                          </span>
                        </button>
                      )}
